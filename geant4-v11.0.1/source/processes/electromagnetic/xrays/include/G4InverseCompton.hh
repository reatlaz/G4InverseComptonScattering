...
#ifndef G4InverseCompton_h
#define G4InverseCompton_h 1
...
class G4InverseCompton : public G4VDiscreteProcess
{
 public:
  explicit G4InverseCompton(G4LogicalVolume* anEnvelope, G4Material*,
                            G4Material*, G4double, G4double, G4int,
                            const G4String& processName = "XTRenergyLoss",
                            G4ProcessType type          = fElectromagnetic);
  virtual ~G4InverseCompton();

  virtual void ProcessDescription(std::ostream&) const override;
  virtual void DumpInfo() const override { ProcessDescription(G4cout); };

  G4InverseCompton(G4InverseCompton&) = delete;
  G4InverseCompton& operator=(const G4InverseCompton& right) = delete;
 ...
 protected:
  ...
  static constexpr G4double fMinProtonTkin = 10. * CLHEP::GeV;
  // max Tkin of proton in tables
  static constexpr G4double fMaxProtonTkin = 10. * CLHEP::TeV;
